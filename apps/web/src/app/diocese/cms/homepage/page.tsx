...
const DEFAULT_SECTIONS: HomepageSection[] = [
  ...
  { id: 'welcome', type: 'welcome_message', enabled: true, settings: { animation: 'fade' } },
  { id: 'priest', type: 'parish_priest', enabled: true, settings: {} },
  { id: 'mass', type: 'mass_timings', enabled: true, settings: {} },
  { id: 'news', type: 'latest_news', enabled: true, settings: {} },
  ...
  { id: 'donate', type: 'donate', enabled: true, settings: {} },

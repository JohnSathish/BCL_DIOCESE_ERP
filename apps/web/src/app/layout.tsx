  ...
  return (
    <html lang="en" suppressHydrationWarning data-sidebar-style="solid" data-color-theme="navy">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;0,700;1,500&family=Fraunces:opsz,wght@9..144,500;9..144,700&family=Source+Sans+3:wght@400;500;600;700&family=Inter:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body
        ...
        style={{
          ['--font-shp-display' as string]: '"Cormorant Garamond", Georgia, serif',
          ['--font-shp-sans' as string]: 'Inter, system-ui, sans-serif',
        }}
